...
abstract class $ItemModelCopyWith<$Res> {
  ...
  @useResult
  $Res call({String? activity, int? participants, double? price});
}
...
class _$ItemModelImpl with DiagnosticableTreeMixin implements _ItemModel {
  ...
  @JsonKey(ignore: true)
  @override
  int get hashCode => Object.hash(runtimeType, activity, participants, price);
...
abstract class _ItemModel implements ItemModel {
  const factory _ItemModel(
      {final String? activity,
      final int? participants,
      final double? price}) = _$ItemModelImpl;
